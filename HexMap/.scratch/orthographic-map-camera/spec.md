...
| zoom 上限 | 最小可视宽度 = 地图宽 × `m_MinVisibleWidthRatio`（默认 `0.15`）⇒ `map.unity` 竖屏下 `zoom_max ≈ 8.2` |
...
| 2.0 | `8.663` | `9.75 × 17.33` | ❌ | `±15.04` | `±7.09` | 24% |
| 4.0 | `4.331` | `4.87 × 8.66` | ❌ | `±17.48` | `±11.42` | 12% |
| **8.2（上限）** | `2.113` | `2.38 × 4.23` | ❌ | `±18.73` | `±13.64` | 6% |
